<div class="container" style="padding-top: 150px">
	<div class="row">
		<div class="col-md-12">
			<form class="form-horizontal" action="/server/index" method="post">
			  
			  <div class="form-group">
			    <label for="inputEmail3" class="col-sm-2 control-label">关于本站</label>
			    <div class="col-sm-10">
			      <textarea name='contents' class="form-control" rows="3"><?php echo $contents['main'] ?></textarea>
