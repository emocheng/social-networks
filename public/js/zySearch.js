	...
	$.fn.zySearch = function(options,param){
		...
		return this.each(function(){
			...
			this.createHtml = function(){
				...
				var html = '';
				html +='<form action="/home/search" method="post">';
				html += '<b class="search-img"></b>'; 
				html += '<input id="searchInput" name="search-name"  class="search-input" type="text" placeholder="搜索小贱鸡？">';
				html += '<button class="search-btn btn" id="search-submit">搜索</button>';
				html += '</form>';
				$(self).append(html);
